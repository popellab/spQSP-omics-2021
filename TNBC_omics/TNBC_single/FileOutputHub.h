...
public:
	...
	//! get pointer to file stream for Tumor Volume
	ofstream& getTumorVolumeFstream() { return _TumorVolume; }
...
private:
	...
	//! output stream tumor volume at every time step
	ofstream _TumorVolume;
